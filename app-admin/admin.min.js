...
var AngularFireCartAdmin = angular.module("AngularFireCartAdmin", [ "ngRoute", "firebase" ]).value("fbURL", "https://tienda-virtual-8e0b7.firebaseio.com/");
...
AngularFireCartAdmin.config(function($routeProvider) {
    ...
    $scope.products = products.$asArray(), $scope.predicate = "-sku", $scope.categories = [ {
        ...
        }), $scope.sku = $scope.sku + 1, $scope.title = "", $scope.price = "", $scope.image = "", $scope.fichat = "",
